		...
		<header class="fixed w-full z-30 py-3 px-5 lg:px-52 header-transparent backdrop-blur">
			<div class="container mx-auto grid grid-cols-4 col-auto items-center">
				<div class="font-bold flex items-center col-span-3 lg:col-span-1">
					...
					<a href="#home"><p class="font-merriweather text-lg">Beasiswa Sampah</p></a>
				</div>
				<nav class="header-nav col-span-2 hidden gap-1 lg:flex lg:justify-center">
					<a href="#about" class="nav-link rounded-full px-3 py-1.5">About</a>
					<a href="#program" class="nav-link rounded-full px-3 py-1.5">Program</a>
					<a href="#peringkat" class="nav-link rounded-full px-3 py-1.5">Peringkat</a>
					<a href="#contact" class="nav-link rounded-full px-3 py-1.5">Contact</a>
				</nav>
