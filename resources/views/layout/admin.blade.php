        ...
        <aside id="sidebar" class="md:col-span-1 hidden md:inline z-10 shadow-md">
            <div class=" h-screen px-3 py-4 overflow-y-auto bg-gray-50 dark:bg-gray-800">
                <ul class="space-y-2 font-medium">
                    ...
                    <li>
                        <a href="{{ route('admin.dana') }}" class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                            <span class="ms-3">RUD Dana</span>
                        </a>
                    </li>
                </ul>
            </div>
